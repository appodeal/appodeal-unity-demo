...
namespace AppodealAds.Unity.Api {
	...
	public class Appodeal {
		...
		public const string APPODEAL_PLUGIN_VERSION = "2.8.58";
		...
		public static string getUnityVersion () {
			...
			if (string.IsNullOrEmpty (unityVersion)) {
				PropertyInfo appId = typeof (Application).GetProperty ("identifier", BindingFlags.Public | BindingFlags.Static);
