...
namespace Appodeal.Unity.Editor
{
    ...
    public static class AppodealUnityUtils
    {
        ...
        public static string getApplicationId()
        {
            ...
            Debug.Assert(appId != null, appId + " != null");
        ...
        private static int GetLatestInstalledAndroidPlatformVersion()
        {
            ...
            {
                var match = buildToolsRegex.Match(platform);
                var thisVersion = Int32.Parse(match.Groups[1].Value);
        ...
        public static string getXcodeVersion()
        {
            ...
            try
            {
                ...
                {
                    StartInfo =
                        new ProcessStartInfo("system_profiler", "SPDeveloperToolsDataType | grep \"Xcode:\"")
                        {
